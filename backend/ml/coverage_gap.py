...
class CoverageGapAnalyzer:
    ...
    def identify_opportunity_zones(self, min_population: int = 100000,
                                   max_coverage: int = 0) -> pd.DataFrame:
        """
    ...
    def analyze_by_city_tier(self) -> pd.DataFrame:
        ...
        tier_analysis = self.merged_df.groupby("city_tier").agg({
            "pincode": "count",
        ...
        tier_analysis.columns = [
            "total_pincodes", "avg_coverage", "median_coverage",
            "total_population", "blinkit_count", "zepto_count", "instamart_count"
        ]
    ...
    def analyze_by_state(self) -> pd.DataFrame:
        ...
        state_analysis = self.merged_df.groupby("state").agg({
            "pincode": "count",
            "coverage_score": "mean",
            "population": "sum"
        }).round(2)
