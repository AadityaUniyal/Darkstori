    ...
    def stop_server(self, timeout: int = 10) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.warning("MLflow server did not stop gracefully, forcing shutdown")
                self.process.kill()
                self.process.wait()
...
def start_mlflow_server_daemon(config: Optional[MLflowConfig] = None) -> MLflowServerManager:
