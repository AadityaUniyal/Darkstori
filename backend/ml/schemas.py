...
class PredictionRequest(BaseModel):
    ...
    coverage_score: int = Field(..., ge=0, le=4, description="Platform coverage score (0-4)")
...
class BatchPredictionRequest(BaseModel):
    ...
    output_path: Optional[str] = Field(None, description="Path for output CSV (optional)")
...
class DriftDetectionResponse(BaseModel):
    ...
    drift_details: List[Dict[str, Any]] = Field(..., description="Drift details per feature")
