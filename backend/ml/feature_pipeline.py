...
class FeaturePipeline:
    ...
    def log_engineered_features(self, df: pd.DataFrame) -> None:
        ...
        """
        try:
            self.engineered_features = [col for col in df.columns if col not in self.raw_columns]
            ...
            if self.tracker:
                ...
                self.tracker.log_param("engineered_feature_count", len(self.engineered_features))
    ...
    def log_missing_value_strategy(self, strategy: str, details: Dict[str, Any]) -> None:
    ...
    def calculate_and_log_statistics(self, df: pd.DataFrame, dataset_name: str = "train") -> None:
    ...
    def calculate_and_log_correlation(self, df: pd.DataFrame, target_col: Optional[str] = None) -> None:
    ...
    def _plot_correlation_heatmap(self, corr_matrix: pd.DataFrame, top_n: int = 30) -> None:
    ...
    def log_outlier_removal(self, before_count: int, after_count: int, method: str) -> None:
        ...
        try:
            ...
            logger.info(f"Logged outlier removal: {before_count - after_count} samples removed")
    ...
    def prepare_features(
        ...
        try:
            ...
            if handle_missing == "median":
                ...
                self.log_missing_value_strategy("forward_fill", {"columns": list(X.columns)})
