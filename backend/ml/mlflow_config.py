...
class MLflowConfig:
    ...
    def from_yaml(cls, yaml_path: str) -> "MLflowConfig":
        ...
        # Create main config
        tracking_uri = mlflow_config.get('tracking_uri', os.getenv('MLFLOW_TRACKING_URI', ''))
...
class MonitoringConfig(BaseModel):
    ...
    performance_degradation: PerformanceDegradationConfig = Field(default_factory=PerformanceDegradationConfig)
