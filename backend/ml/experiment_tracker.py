...
class ExperimentTracker:
    ...
    def log_figure(self, figure: plt.Figure, filename: str, artifact_path: Optional[str] = None) -> None:
    ...
    def log_dataset(self, df: pd.DataFrame, name: str, artifact_path: Optional[str] = None) -> None:
    ...
    def log_dict(self, data: Dict, name: str, artifact_path: Optional[str] = None) -> None:
