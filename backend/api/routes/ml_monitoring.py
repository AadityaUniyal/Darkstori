...
async def get_performance_metrics(
    ...
    try:
        ...
        metrics = await monitor.calculate_rolling_metrics(
            model_name=model_name, model_version=model_version, window_days=window_days
        )
...
async def get_performance_history(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to retrieve performance history"
        )
...
async def get_drift_status(
    ...
    try:
        ...
        drift_history = await monitor.get_drift_history(
            model_name=model_name, days=recent_days
        )
...
async def check_drift(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to perform drift check")
...
async def check_degradation(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to check performance degradation"
        )
...
async def get_recent_predictions(
    ...
    try:
        ...
        from database.models.models import MLPrediction
        ...
        raise HTTPException(
            status_code=500, detail="Failed to retrieve recent predictions"
        )
