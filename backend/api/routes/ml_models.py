...
async def list_models(
    ...
    try:
        ...
        for model in models:
            # Get latest versions
            try:
                production_version = registry.get_latest_model(model.name, stage="Production")
...
async def transition_model_stage(
    ...
    try:
        # Log admin action
        logger.info(f"Admin {admin.get('sub', 'unknown')} transitioning model {request.model_name}")
