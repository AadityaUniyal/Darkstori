...
async def get_estimated_delivery_times(
    ...
    **Use Case**: Help customers choose fastest platform
    ...
    try:
        ...
        fastest_platform = min(available_times, key=available_times.get) if available_times else None
        ...
        return {
            ...
            "fastest_time": available_times.get(fastest_platform) if fastest_platform else None
        }
