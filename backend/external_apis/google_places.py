...
from src.utils.config import GOOGLE_MAPS_API_KEY, EXTERNAL_DATA_DIR, PLATFORMS
...
class PlacesAPI:
    ...
    def find_darkstores_nearby(self, lat: float, lng: float, 
        ...
        """
        keyword = platform if platform else "Blinkit OR Zepto OR Swiggy Instamart OR Flipkart Minutes"
